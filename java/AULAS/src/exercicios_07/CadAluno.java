...
public class CadAluno {
	...
	public static void main(String[]args)
	{
		...
		do {
			...
			System.out.printf("G4-%d : %s",matricula,alunos[(matricula-1)]);
		...
		for(int nota=0;nota<alunos.length;nota++)
		{
			if(notas[nota]!=0)
			{
				System.out.printf("\nO(a) aluno(a) %s obteve %d de nota",alunos [matricula-1], notas[nota]);
			}
		}
		}
}
